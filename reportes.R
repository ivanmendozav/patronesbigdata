...
#4 Trip segmentation
tripdata <- segmentTrips(datapoints, minttime = 300, maxtime = 3600) #get trips 10 minutes < x < 1 hour
...
#5. stats for week day trips
tripdata %>% filter(wday >=2 & wday <= 6 & home=="N") -> tripdata
